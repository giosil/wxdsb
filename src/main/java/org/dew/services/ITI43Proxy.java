...
public
class ITI43Proxy extends HttpServlet
{
	private static final long serialVersionUID = 5702778129848497104L;
	
	protected static final String REQUEST_NAME = "RetrieveDocumentSetRequest";
	
	protected boolean TRANSMISSION_USING_MTOM_XOP = true;
	...
	{
		handlerClass = getServletContext().getInitParameter("PROXY");
	}
		...
		throws ServletException, IOException
	{
		...
		try {
			IXDSb xdsb = ServicesFactory.getXDSbProxy(handlerClass);
