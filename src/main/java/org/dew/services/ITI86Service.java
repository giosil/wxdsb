...
import org.dew.xds.RemoveDocumentsRequest;
import org.dew.xds.RmdContentHandler;
import org.dew.xds.util.WSUtil;

public
class ITI86Service extends HttpServlet
{
    ...
    throws ServletException, IOException
  {
    ...
    if(isWSDLRequest) {
      RequestDispatcher requestDispatcher = request.getRequestDispatcher("/wsdl/xds-iti86.jsp");
    ...
    throws ServletException, IOException
  {
    ...
    RemoveDocumentsRequest removeDocumentsRequest = null;
    try {
      RmdContentHandler rmdContentHandler = new RmdContentHandler();
      rmdContentHandler.load(soapRequest);
      removeDocumentsRequest = rmdContentHandler.getRemoveDocumentsRequest();
    }
    catch(Exception ex) {
    ...
    try {
      ...
      result = xdsb.removeDocumentSet(removeDocumentsRequest, WSUtil.toArray(basicAuth, listOfAssertion));
