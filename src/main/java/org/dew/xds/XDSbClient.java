...
class XDSbClient implements IXDSb
{
	...
	public XDSbClient(String sURLITI18, String sURLITI41, String sURLITI42, String sURLITI43, String sURLITI62, String sURLITI57, String sURLITI86)
	{
		this.urlITI18 = sURLITI18;
		this.urlITI41 = sURLITI41;
		this.urlITI42 = sURLITI42;
	...
	public String getUrlITI86() {
		return urlITI86;
	}
	
	public void setUrlITI86(String urlITI86) {
		this.urlITI86 = urlITI86;
	}
	...
	XDSDocumentResponse retrieveDocumentSet(XDSDocumentRequest request, AuthAssertion[] arrayOfAssertion)
	{
		...
		try {
			...
			// "x" (XOP) evita conversione risposta in UTF-8
			if(sslSocketFactory != null) {
				soapResponse = WSUtil.sendRequest(urlITI43, sslSocketFactory, basicAuth, connTimeout, readTimeout, "x", "urn:ihe:iti:2007:RetrieveDocumentSet", sbRequest.toString().getBytes());
			}
			else {
				soapResponse = WSUtil.sendRequest(urlITI43, basicAuth, connTimeout, readTimeout, "x", "urn:ihe:iti:2007:RetrieveDocumentSet", sbRequest.toString().getBytes());
			}
	...
	RegistryResponse updateDocumentSet(XDSDocument[] arrayOfXDSDocument, AuthAssertion[] arrayOfAssertion)
	{
		...
		sbRequest.append("<Action xmlns=\"http://www.w3.org/2005/08/addressing\">urn:ihe:iti:2010:UpdateDocumentSet</Action>");
		sbRequest.append("<ReplyTo xmlns=\"http://www.w3.org/2005/08/addressing\">");
		sbRequest.append("<Address>http://www.w3.org/2005/08/addressing/anonymous</Address>");
		sbRequest.append("</ReplyTo>");
		sbRequest.append("<FaultTo xmlns=\"http://www.w3.org/2005/08/addressing\">");
	...
	{
		if(removeDocumentsRequest == null || removeDocumentsRequest.size() == 0) {
			throw new RuntimeException("Invalid removeDocumentsRequest");
		}
		List<XDSDocumentRequest> listOfXDSDocumentRequest = removeDocumentsRequest.getListOfXDSDocumentRequest();
		if(listOfXDSDocumentRequest == null || listOfXDSDocumentRequest.size() == 0) {
			throw new RuntimeException("Invalid removeDocumentsRequest");
		}
		
		if(urlITI86 == null || urlITI86.length() == 0) {
			throw new RuntimeException("Invalid URL DocumentRepository_RemoveDocumentSet (urlITI86=" + urlITI86 + ")");
		}
		
		StringBuilder sbRequest = new StringBuilder(800);
		sbRequest.append("<soap:Envelope xmlns:soap=\"http://www.w3.org/2003/05/soap-envelope\">");
		sbRequest.append("<soap:Header>");
		sbRequest.append("<To xmlns=\"http://www.w3.org/2005/08/addressing\">" + urlITI86 + "</To>");
		sbRequest.append("<Action xmlns=\"http://www.w3.org/2005/08/addressing\">urn:ihe:iti:2017:RemoveDocuments</Action>");
		sbRequest.append("<ReplyTo xmlns=\"http://www.w3.org/2005/08/addressing\">");
		sbRequest.append("<Address>http://www.w3.org/2005/08/addressing/anonymous</Address>");
		sbRequest.append("</ReplyTo>");
		sbRequest.append("<FaultTo xmlns=\"http://www.w3.org/2005/08/addressing\">");
		...
		sbRequest.append("</soap:Header>");
		sbRequest.append("<soap:Body>");
		sbRequest.append("<rmd:RemoveDocumentsRequest xmlns:rmd=\"urn:ihe:iti:rmd:2017\" xmlns:xds=\"urn:ihe:iti:xds-b:2007\">");
		for(int i = 0; i < listOfXDSDocumentRequest.size(); i++) {
			XDSDocumentRequest xdsDocumentRequest = listOfXDSDocumentRequest.get(i);
			sbRequest.append(xdsDocumentRequest.toXML("xds"));
		}
		sbRequest.append("</rmd:RemoveDocumentsRequest>");
		sbRequest.append("</soap:Body>");
		sbRequest.append("</soap:Envelope>");
		...
		try {
			...
			if(sslSocketFactory != null) {
				soapResponse = WSUtil.sendRequest(urlITI86, sslSocketFactory, basicAuth, connTimeout, readTimeout, null, sbRequest.toString().getBytes());
			}
			else {
				soapResponse = WSUtil.sendRequest(urlITI86, basicAuth, connTimeout, readTimeout, null, sbRequest.toString().getBytes());
			}
