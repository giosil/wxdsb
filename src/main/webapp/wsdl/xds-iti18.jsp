...
<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema"
	...
	<xsd:import namespace="urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0"
		schemaLocation="http://<%=request.getServerName()%>:<%=request.getServerPort()%>/wxdsb/xsd/query.xsd" />
</xsd:schema>
</types>
...
<binding name="DocumentRegistry_Binding_Soap11"
	type="ihe:DocumentRegistry_PortType">
...
<port binding="ihe:DocumentRegistry_Binding_Soap12"
	name="DocumentRegistry_Port_Soap12">
<soap12:address
	location="http://<%=request.getServerName()%>:<%=request.getServerPort()%>/wxdsb/XDSDocumentRegistryQuery/RegistryStoredQuery" />
</port>
<port binding="ihe:DocumentRegistry_Binding_Soap11"
	name="DocumentRegistry_Port_Soap11">
<soap:address
	location="http://<%=request.getServerName()%>:<%=request.getServerPort()%>/wxdsb/XDSDocumentRegistryQuery/RegistryStoredQuery" />
</port>
</service>
